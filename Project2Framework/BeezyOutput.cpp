...
* A recursive top down parser, using a lexical analyzer, with minimal error    *
* recovery. Output matches expected output.                                    *
*******************************************************************************/
...
int SyntacticalAnalyzer::define ()
{
	...
	p2file << "Entering Define function; current token is: " << lex->GetTokenName(token) << ", lexeme: " << lex->GetLexeme() << endl; //enter funct name
	int errors = 0;
	...
	p2file << "Exiting Define function; current token is: " << lex->GetTokenName(token) << endl; //enter funct name
	<< lex->GetTokenName (token) << endl;
...
*/
	...
	p2file << "Exiting More_Defines function; current token is: " << lex->GetTokenName(token) << endl; //enter funct name
...
*/
	...
	p2file << "Entering Stmt_List function; current token is: " << lex->GetTokenName(token) << ", lexeme: " << lex->GetLexeme() << endl; //enter funct name
	int errors = 0;
	//check if current token is in first and follows of respective
	...
	p2file << "Exiting Stmt_List function; current token is: " << lex->GetTokenName(token) << endl; //enter funct name
...
*/
	...
	p2file << "Entering Stmt function; current token is: " << lex->GetTokenName(token) << ", lexeme: " << lex->GetLexeme() << endl; //enter funct name
	int errors = 0;
	//check if current token is in first and follows of respective
